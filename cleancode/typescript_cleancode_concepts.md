...
Typescript cleancode concepts.
Inspired from [clean-code-typescript]( https://github.com/labs42io/clean-code-typescript/tree/main ).
...
For me, number one rule of thumb to check whether my code is clean is to re-read it and see if I can still under the code after 1 month, 6 months, or 1 year.
...
**[⬆ back to top](#table-of-contents)**q
